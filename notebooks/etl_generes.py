...
# Asegura que las cadenas se conviertan a listas de diccionarios
...
# Elimina duplicados basados en las columnas 'id' y 'name'
df_genres = df_genres.drop_duplicates(subset=['id', 'name'])

# Resetea el índice para un DataFrame limpio
